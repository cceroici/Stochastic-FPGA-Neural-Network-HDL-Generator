...
module cascLFSR_32Tap(TRIG,RESET,
...
LFSR16_32Tap LFSRtop(
	...
	.OUT16(OUT16),.OUT17(OUT17),.OUT18(OUT18),.OUT19(OUT19),.OUT20(OUT20),.OUT21(OUT21),.OUT22(OUT22),.OUT23(OUT23),
	.OUT24(OUT24),.OUT25(OUT25),.OUT26(OUT26),.OUT27(OUT27),.OUT28(OUT28),.OUT29(OUT29),.OUT30(OUT30),.OUT31(OUT31),
	.SEED(SD_TOP)
);
